...
def main():
	...
	ax_axis = [0]
	ay_axis = [0]
	kin_data = find_inverse_kinematics(goal, variables, 10000, cost=p5_cost, ALPHA=BEST_ALPHA, ay_axis=ay_axis, ax_axis=ax_axis, original_configuration=original_configuration)
	fg, ax1 = plt.subplots()
